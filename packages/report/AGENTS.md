...
- Two outbound requests only, both from `src/api.ts`, both user-initiated: the gate form and the meeting-request form. The print control is not an outbound request.
